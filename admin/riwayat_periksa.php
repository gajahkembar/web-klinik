...
// Ambil data riwayat seluruh pasien
                ...
                <table id="riwayatTable" class="table table-bordered table-striped mt-3">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 15%;">Nama Pasien</th> <!-- Kolom Nama Pasien -->
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?php echo $no++; ?></td>
                                <td><?php echo htmlspecialchars($row['nama_pasien']); ?></td> <!-- Menampilkan Nama Pasien -->
